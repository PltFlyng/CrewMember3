...
public class WindComponentActivity extends ActionBarActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent newintent = new Intent(WindComponentActivity.this, UserDetailsActivity.class);
        ...
        if (id == R.id.action_about) {
            Intent newintent = new Intent(WindComponentActivity.this, AboutActivity.class);
            startActivity(newintent);
            return true;
        }
